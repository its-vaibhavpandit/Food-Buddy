...
const SOCIAL_LINKS = [
  {
    ...
    hoverClass: "hover:bg-[#1877F2] hover:text-white hover:shadow-[0_0_15px_rgba(24,119,242,0.4)] hover:border-[#1877F2]",
  },
  {
    label: "Instagram",
    ...
    hoverClass: "hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:text-white hover:shadow-[0_0_15px_rgba(238,42,123,0.4)] hover:border-transparent",
  },
  {
    label: "Telegram",
    ...
    hoverClass: "hover:bg-[#0088cc] hover:text-white hover:shadow-[0_0_15px_rgba(0,136,204,0.4)] hover:border-[#0088cc]",
  },
  {
    label: "Snapchat",
    ...
    hoverClass: "hover:bg-[#FFFC00] hover:text-black hover:shadow-[0_0_15px_rgba(255,252,0,0.5)] hover:border-[#FFFC00]",
  },
  {
    label: "WhatsApp",
    ...
    hoverClass: "hover:bg-[#25D366] hover:text-white hover:shadow-[0_0_15px_rgba(37,211,102,0.4)] hover:border-[#25D366]",
  }
];
...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-border-val)] bg-[var(--color-surface)]">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div className="space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="relative h-9 w-9 overflow-hidden rounded-xl bg-[var(--color-surface-elevated)] p-1 flex items-center justify-center border border-[var(--color-border-val)] shadow-[var(--shadow-level-1)]">
                <Image
                  src="/images/logo.svg"
              ...
              <span className="text-lg font-black tracking-tight text-[var(--color-text-primary)] font-[family-name:var(--font-display)]">
                Fast Food
          ...
          {/* Quick Links */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-wider text-[var(--color-text-muted)]">
              Quick Links
            </h4>
            <ul className="space-y-2.5">
              {FOOTER_NAV.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-[var(--color-text-secondary)] transition-colors hover:text-flame-500"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2.5 text-sm text-[var(--color-text-secondary)]">
                <CallCalling
                  size={16}
                  variant="Bold"
            ...
            <div className="mt-5 flex items-center gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--color-border-val)] bg-[var(--color-surface-elevated)] text-[var(--color-text-secondary)] transition-all duration-300 hover:-translate-y-1 hover:scale-110 active:scale-95 ${social.hoverClass}`}
                >
        ...
        {/* Bottom Bar */}
        <div className="mt-10 border-t border-[var(--color-border-val)] pt-6 text-center text-xs text-[var(--color-text-muted)]">
